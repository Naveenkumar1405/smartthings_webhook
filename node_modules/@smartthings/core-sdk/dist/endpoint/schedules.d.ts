import { Endpoint } from '@smartthings/core-sdk/dist/endpoint';
import { EndpointClientConfig } from '@smartthings/core-sdk/dist/endpoint-client';
import { Status } from '@smartthings/core-sdk/dist/types';
import { ConfigEntry } from '@smartthings/core-sdk/dist/endpoint/installedapps';
...
export declare class SchedulesEndpoint extends Endpoint {
     ...
     */
    list(installedAppId?: string): Promise<Schedule[]>;
    /**
     ...
     * parameter is not needed.
     */
    get(name: string, installedAppId?: string): Promise<Schedule>;
    /**
     * Create a schedule
     ...
     * parameter is not needed.
     */
    create(data: Schedule, installedAppId?: string): Promise<Schedule>;
    /**
     ...
     * parameter is not needed.
     */
    delete(name?: string, installedAppId?: string): Promise<Status>;
    /**
     ...
     * parameter is not needed.
     */
    schedule(name: string, expression: string, timezone?: string, installedAppId?: string): Promise<Schedule>;
    /**
     ...
     * parameter is not needed.
     */
    runDaily(name: string, dateOrConfig: (string | ConfigEntry[] | Date), timezone?: string, installedAppId?: string): Promise<Schedule>;
    /**
     *
     * @param name
     * @param dateTime
     ...
     */
    runOnce(name: string, dateTime: number | Date, overwrite?: boolean, installedAppId?: string): Promise<Schedule>;
    /**
     ...
     * parameter is not needed.
     */
    runIn(name: string, delay: number, overwrite?: boolean, installedAppId?: string): Promise<Schedule>;
    /**
     ...
     */
    unschedule(name: string, installedAppId?: string): Promise<Status>;
    /**
     ...
     */
    unscheduleAll(installedAppId?: string): Promise<Status>;
}
