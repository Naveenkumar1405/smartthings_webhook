...
import { EndpointClientConfig, HttpClientParams } from '@smartthings/core-sdk/dist/endpoint-client';
import { CapabilityVisibleCondition, CapabilityLabeledState, CapabilityGrouped, CapabilityDashboardAction, CapabilityDashboardBasicPlusItem, CapabilityDetailView, CapabilityMultiArgCommand, CapabilityAutomationCondition, CapabilityAutomationAction } from '@smartthings/core-sdk/dist/endpoint/capabilities';
export declare enum PatchItemOpEnum {
    ADD = "add",
    REPLACE = "replace",
    REMOVE = "remove"
}
...
export declare class PresentationEndpoint extends Endpoint {
     ...
     */
    generate(profileId: string, extraParams?: HttpClientParams): Promise<PresentationDeviceConfig>;
    /**
     ...
     */
    get(presentationId: string, manufacturerName?: string): Promise<PresentationDeviceConfig>;
    /**
     * Make an idempotent call to either create or update a device configuration
     * based on the structure of the provided payload.
     */
    create(deviceConfig: PresentationDeviceConfigCreate): Promise<PresentationDeviceConfig>;
    /**
     * Get a device presentation. If manufacturerName is omitted the default SmartThingsCommunity manufacturerName is used.
     * @param presentationId The id returned from the device config create operation
     * @param manufacturerName The manufacturer name, e.g. SmartThingsCommunity
     */
    getPresentation(presentationId: string, manufacturerName?: string): Promise<PresentationDevicePresentation>;
}
