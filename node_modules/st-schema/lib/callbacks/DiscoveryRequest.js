...
const checkFetchStatus = require('st-schema/lib/util/checkFetchStatus');
const STBase = require("st-schema/lib/STBase");
const {v4: uuidv4} = require("uuid");
const RefreshTokenRequest = require('st-schema/lib/callbacks/RefreshTokenRequest');
const doSendDiscovery = Symbol("private");

module.exports = class DiscoveryRequest extends STBase {

  constructor(clientId, clientSecret) {
    super('discoveryCallback', uuidv4());
