...
const DiscoveryResponse = require("st-schema/lib/discovery/DiscoveryResponse");
const StateRefreshResponse = require("st-schema/lib/state/StateRefreshResponse");
const CommandResponse = require("st-schema/lib/state/CommandResponse");
const AccessTokenRequest = require("st-schema/lib/callbacks/AccessTokenRequest");
const STBase = require('st-schema/lib/STBase');
const GlobalErrorTypes = require('st-schema/lib/errors/global-error-types');
