...
const Component = require('st-schema/lib/discovery/DiscoveryComponent');
...
class Device {
  ...
  /**
   * Optional identifier that is a unique representation of the device within the integrator's ecosystem. Used for
   * de-duplicating devices when there are multiple ways of connecting them.
   * @param id {string} Unique identifier within the integrator's ecosystem
   */
  deviceUniqueId(id) {
